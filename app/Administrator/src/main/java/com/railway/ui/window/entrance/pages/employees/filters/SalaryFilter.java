...
public class SalaryFilter extends FilterInterface implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        new NumberFieldController(minSalary);
        new NumberFieldController(maxSalary);
    }
    ...
    public Collection<Matcher> getMatchers() {
        ...
        if (!min.isEmpty()) {
            matchers.add(new EmployeeMatchers.MatchBySalary()
