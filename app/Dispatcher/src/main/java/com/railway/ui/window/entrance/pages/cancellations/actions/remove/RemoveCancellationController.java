...
public class RemoveCancellationController extends WindowController implements Initializable {
    private RemoveCancellationModel model = new RemoveCancellationModel();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        removeButton.setOnMouseClicked(e -> {
            ...
            int result = model.removeCancellation(Integer.parseInt(text), LocalDateTime.of(
